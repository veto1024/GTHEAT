...
import numpy as np
from Widgets.chi_i import chi_i
...
class MainWindow(QMainWindow):
    ...
    def setSmallGraphs(self, shot: chi_i):
        ...
        self.shotTempGraph.updateFig(shot.rho, [shot.T.i.ev.fsa, shot.T.e.ev.fsa], legend=[r"$T_i$", r"$T_e$"], yFormatter=FormatStrFormatter('%.0E'))
